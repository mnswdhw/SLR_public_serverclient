...
def CIFAR10_iid(num_clients, datapoints, path, transform_train, transform_test):
    ...
    new_test_dataset,_ = torch.utils.data.random_split(test_dataset, (100, 9900))  #keeping 2k datapoints with each client
...
def load_full_dataset(dataset, dataset_path, num_clients, datapoints = None, pretrained = False,transform_train = None, transform_test = None):
    ...
    if dataset == "cifar10_tl":
        ...
        train_dataset, test_dataset = CIFAR10_iid(num_clients, datapoints, dataset_path, transform_train, transform_test)
        input_channels = 3
